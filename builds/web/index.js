...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/cactus.png", "start": 0, "end": 372}, {"filename": "/assets/ded_square_man.png", "start": 372, "end": 713}, {"filename": "/assets/square_man.png", "start": 713, "end": 1005}], "remote_package_size": 1005});

  })();

// end include: /tmp/tmp_dn955mv.js
// include: /tmp/tmpagwr1skz.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpagwr1skz.js
// include: /tmp/tmpkmrcj3ox.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpkmrcj3ox.js
...
var ASM_CONSTS = {
  96744: () => { if (document.fullscreenElement) return 1; },  
 96790: () => { return Module.canvas.width; },  
 96822: () => { return parseInt(Module.canvas.style.width); },  
 96870: () => { document.exitFullscreen(); },  
 96897: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 96970: () => { if (document.fullscreenElement) return 1; },  
 97016: () => { return Module.canvas.width; },  
 97048: () => { return screen.width; },  
 97073: () => { document.exitFullscreen(); },  
 97100: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97233: () => { return window.innerWidth; },  
 97259: () => { return window.innerHeight; },  
 97286: () => { if (document.fullscreenElement) return 1; },  
 97332: () => { return Module.canvas.width; },  
 97364: () => { return parseInt(Module.canvas.style.width); },  
 97412: () => { if (document.fullscreenElement) return 1; },  
 97458: () => { return Module.canvas.width; },  
 97490: () => { return screen.width; },  
 97515: () => { return window.innerWidth; },  
 97541: () => { return window.innerHeight; },  
 97568: () => { if (document.fullscreenElement) return 1; },  
 97614: () => { return Module.canvas.width; },  
 97646: () => { return screen.width; },  
 97671: () => { document.exitFullscreen(); },  
 97698: () => { if (document.fullscreenElement) return 1; },  
 97744: () => { return Module.canvas.width; },  
 97776: () => { return parseInt(Module.canvas.style.width); },  
 97824: () => { document.exitFullscreen(); },  
 97851: ($0) => { Module.canvas.style.opacity = $0; },  
 97889: () => { return screen.width; },  
 97914: () => { return screen.height; },  
 97940: () => { return window.screenX; },  
 97967: () => { return window.screenY; },  
 97994: () => { return window.devicePixelRatio; },  
 98030: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98083: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98134: () => { Module.canvas.style.cursor = 'none'; },  
 98171: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98427: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98478: () => { if (document.fullscreenElement) return 1; },  
 98524: () => { return window.innerWidth; },  
 98550: () => { return window.innerHeight; },  
 98577: () => { if (document.pointerLockElement) return 1; }
};
